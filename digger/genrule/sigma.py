...
def _tags(finding: dict) -> list[str]:
    ...
    detector_tag_map = {
        ...
        "info_stealer":         ["attack.credential_access", "attack.t1555.003",
                                  "attack.t1041"],
        "k8s_security":         ["attack.t1611", "attack.t1098",
                                  "attack.t1525", "attack.t1078.001",
                                  "attack.privilege_escalation"],
        "idp_security":         ["attack.t1110.003", "attack.t1621",
                                  "attack.t1098.001", "attack.t1078.004",
                                  "attack.t1556.007", "attack.credential_access",
                                  "attack.persistence"],
        "slsa_audit":           ["attack.t1195.002", "attack.t1525",
                                  "attack.initial_access",
                                  "attack.supply_chain_compromise"],
        "android_security":     ["attack.t1417", "attack.t1437.001",
                                  "attack.t1404", "attack.t1623",
                                  "attack.t1626", "attack.t1429",
                                  "attack.t1430", "attack.t1633",
                                  "attack.t1636.003", "attack.t1636.004"],
        "mcp_audit":            ["attack.t1195", "attack.t1195.001",
                                  "attack.t1195.002", "attack.t1059",
                                  "attack.t1552.001", "attack.t1071.001",
                                  "attack.initial_access",
                                  "attack.supply_chain_compromise"],
        "ci_workflow_audit":    ["attack.t1195.002", "attack.t1199",
                                  "attack.t1059", "attack.t1552.001",
                                  "attack.t1078.004",
                                  "attack.initial_access",
                                  "attack.execution",
                                  "attack.supply_chain_compromise"],
        "git_hook_audit":       ["attack.t1546", "attack.t1059",
                                  "attack.t1027", "attack.t1505.003",
                                  "attack.t1195",
                                  "attack.persistence",
                                  "attack.execution",
                                  "attack.defense_evasion"],
        "macos_tcc":            ["attack.t1543.001", "attack.t1056.001",
                                  "attack.t1417", "attack.t1113",
                                  "attack.t1123", "attack.t1125",
                                  "attack.persistence",
                                  "attack.collection",
                                  "attack.credential_access"],
        "macos_launchd":        ["attack.t1543.001", "attack.t1059.004",
                                  "attack.t1059.002", "attack.t1027",
                                  "attack.t1036", "attack.t1546",
                                  "attack.persistence",
                                  "attack.execution",
                                  "attack.defense_evasion"],
        "vscode_audit":         ["attack.t1195.002", "attack.t1546",
                                  "attack.t1059", "attack.t1557",
                                  "attack.t1505.003",
                                  "attack.persistence",
                                  "attack.execution",
                                  "attack.defense_evasion",
                                  "attack.initial_access"],
        "browser_ext_perms":    ["attack.t1176", "attack.t1185",
                                  "attack.t1539", "attack.t1071.001",
                                  "attack.t1557", "attack.t1556",
                                  ...
                                  "attack.command_and_control",
                                  "attack.defense_evasion"],
        "systemd_audit":        ["attack.t1543.002", "attack.t1059.004",
                                  "attack.t1053.006", "attack.t1027",
                                  "attack.t1546",
                                  "attack.persistence",
                                  "attack.execution",
                                  "attack.defense_evasion"],
        "shell_profile_audit":  ["attack.t1546.004", "attack.t1059.004",
                                  ...
                                  "attack.defense_evasion",
                                  "attack.privilege_escalation"],
        "cron_audit":           ["attack.t1053.003", "attack.t1053.001",
                                  "attack.t1059.004", "attack.t1027",
                                  "attack.t1546", "attack.t1037",
                                  "attack.persistence",
                                  "attack.execution",
                                  "attack.defense_evasion"],
        "windows_registry_audit": ["attack.t1547.001", "attack.t1547.004",
